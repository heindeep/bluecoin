...
In order to support loading of multiple wallets in bluecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bluecoin.cpp.
...
Changes to bluecoin.cpp
----------------------
bluecoin.cpp is the entry point into bluecoin-qt, and as such, will require some minor modifications to provide hooks for
