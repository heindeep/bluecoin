...
This mechanism has been integrated into Bitcore-Node-Bluecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Bluecoin-Project/insight-api-bluecoin#web-socket-api](https://github.com/Bluecoin-Project/insight-api-bluecoin#web-socket-api) 
* API: [https://github.com/Bluecoin-Project/insight-api-bluecoin#swifttx-transactions](https://github.com/Bluecoin-Project/insight-api-bluecoin#swifttx-transactions) 
...
By default, the Bluecoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bluecoin Core daemon:
