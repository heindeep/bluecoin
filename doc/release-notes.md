...
Bluecoin Core version *version* is now available from:

  <https://github.com/bluecoin-project/bluecoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/bluecoin-project/bluecoin/issues>
...
If you are running an older version, shut it down. Wait until it has completely shut down (which might take a few minutes for older versions), then run the installer (on Windows) or just copy over /Applications/Bluecoin-Qt (on Mac) or bluecoind/bluecoin-qt (on Linux).
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/bluecoin-project-translations/).
