...
RESOURCES += src/qt/bluecoin.qrc src/qt/bluecoin_locale.qrc

TRANSLATIONS += src/qt/locale/bluecoin_bg.ts \
                src/qt/locale/bluecoin_de.ts \
                src/qt/locale/bluecoin_en.ts \
                src/qt/locale/bluecoin_es.ts \
                src/qt/locale/bluecoin_fi.ts \
                src/qt/locale/bluecoin_fr.ts \
                src/qt/locale/bluecoin_it.ts \
                src/qt/locale/bluecoin_ja.ts \
                src/qt/locale/bluecoin_pl.ts \
                src/qt/locale/bluecoin_pt.ts \
                src/qt/locale/bluecoin_ru.ts \
                src/qt/locale/bluecoin_sk.ts \
                src/qt/locale/bluecoin_sv.ts \
                src/qt/locale/bluecoin_vi.ts \
                src/qt/locale/bluecoin_zh_CN.ts \
                src/qt/locale/bluecoin_zh_TW.ts
