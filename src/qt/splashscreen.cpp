...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Bluecoin Core");
    ...
    QString copyrightTextBluecoin = QChar(0xA9) + QString(" 2019 ") + QString(tr("The Bluecoin Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextBluecoin);
