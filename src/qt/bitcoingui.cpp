                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bluecoin Core") + " - ";
#ifdef ENABLE_WALLET
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBLUE"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bluecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bluecoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bluecoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Bluecoin Core help message to get a list with possible Bluecoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bluecoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Bluecoin Core"); // default title
