                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zBLUE || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending BLUE because you wouldn't check it anyway.
    if (context == Context::Send_BLUE || context == Context::Send_zBLUE) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR BLUE</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                    ...
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("Bluecoin will close now to finish the encryption process. "
                               ...
                               "your BLUEs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
