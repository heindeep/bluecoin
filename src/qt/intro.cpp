...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bluecoin Core"),
     ...
     * override -datadir in the bluecoin.conf file in the default data directory
     * (to be consistent with bluecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
