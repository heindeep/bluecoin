...
/*
    ...
    result.push_back(Pair("zBLUEsupply", zsnoObj));
*/
    return result;
}
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in bluecoin\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            /*"  \"zBLUEsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zBLUE denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zBLUE denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zBLUE denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zBLUE denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zBLUE denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zBLUE denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zBLUE denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zBLUE denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zBLUE denominations\n"
            "  }\n"
            "}\n"
            */
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"bluecoinaddress\"   	 	(string) bluecoin address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
