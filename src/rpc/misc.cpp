...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total bluecoin balance of the wallet (excluding zerocoins)\n"
        //    "  \"zerocoinbalance\": xxxxxxx, (numeric) the total zerocoin balance of the wallet\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in bluecoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in bluecoin/kb\n"
    ...
    obj.push_back(Pair("zBLUEsupply", zsnoObj));
    */
#ifdef ENABLE_WALLET
    if (pwalletMain) {
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"bluecoinaddress\"     (string, required) The bluecoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"bluecoinaddress\", (string) The bluecoin address validated\n"
            ...
            "}\n"
            "\nExamples:\n" +
            HelpExampleCli("validateaddress", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\"") + HelpExampleRpc("validateaddress", "\"1PSSGeFHDnKNxiEyFrD1wcEaHr9hrQDDWc\""));
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are bluecoin addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) bluecoin address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"bluecoinaddress\"  (string, required) The bluecoin address to use for the signature.\n"
