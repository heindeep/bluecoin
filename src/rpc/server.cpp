...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bluecoin features */
        {"bluecoin", "masternode", &masternode, true, true, false},
        {"bluecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"bluecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bluecoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bluecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bluecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"bluecoin", "startmasternode", &startmasternode, true, true, false},
        {"bluecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bluecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bluecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bluecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bluecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bluecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bluecoin", "mnbudget", &mnbudget, true, true, false},
        {"bluecoin", "preparebudget", &preparebudget, true, true, false},
        {"bluecoin", "submitbudget", &submitbudget, true, true, false},
        {"bluecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bluecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bluecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bluecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bluecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bluecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bluecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bluecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"bluecoin", "mnsync", &mnsync, true, true, false},
        {"bluecoin", "spork", &spork, true, true, false},
        {"bluecoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bluecoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
