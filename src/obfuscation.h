...
{
public:
    /// Is the inputs associated with this public key? (and there is BLUE collateral - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of bluecoin.
