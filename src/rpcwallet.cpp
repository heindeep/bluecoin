...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"bluecoinaddress\"    (string) The new bluecoin address\n"
            "\nExamples:\n" +
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nResult:\n"
            "\"bluecoinaddress\"   (string) The account bluecoin address\n"
            "\nExamples:\n" +
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"bluecoinaddress\"  (string, required) The bluecoin address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n" +
            HelpExampleCli("setaccount", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" \"tabby\"") + HelpExampleRpc("setaccount", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\", \"tabby\""));
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"bluecoinaddress\"  (string, required) The bluecoin address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n" +
            HelpExampleCli("getaccount", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\"") + HelpExampleRpc("getaccount", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\""));
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"bluecoinaddress\"  (string) a bluecoin address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n" +
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"bluecoinaddress\"  (string, required) The bluecoin address to send to.\n"
            ...
            "\nExamples:\n" +
            HelpExampleCli("sendtoaddress", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" 0.1") + HelpExampleCli("sendtoaddress", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" 0.1 \"donation\" \"seans outpost\"") + HelpExampleRpc("sendtoaddress", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\", 0.1, \"donation\", \"seans outpost\""));
...
UniValue sendtoaddressix(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            "sendtoaddressix \"bluecoinaddress\" amount ( \"comment\" \"comment-to\" )\n"
            "\nSend an amount to a given address. The amount is a real and is rounded to the nearest 0.00000001\n" +
            HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"bluecoinaddress\"  (string, required) The bluecoin address to send to.\n"
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n" +
            HelpExampleCli("sendtoaddressix", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" 0.1") + HelpExampleCli("sendtoaddressix", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" 0.1 \"donation\" \"seans outpost\"") + HelpExampleRpc("sendtoaddressix", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\", 0.1, \"donation\", \"seans outpost\""));
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"bluecoinaddress\",     (string) The bluecoin address\n"
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            HelpRequiringPassphrase() + "\n"
                                        "\nArguments:\n"
                                        "1. \"bluecoinaddress\"  (string, required) The bluecoin address to use for the private key.\n"
            ...
            "\nCreate the signature\n" + HelpExampleCli("signmessage", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" \"my message\"") +
            "\nVerify the signature\n" + HelpExampleCli("verifymessage", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" \"signature\" \"my message\"") +
            "\nAs json rpc\n" + HelpExampleRpc("signmessage", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\", \"my message\""));
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "getreceivedbyaddress \"bluecoinaddress\" ( minconf )\n"
            "\nReturns the total amount received by the given bluecoinaddress in transactions with at least minconf confirmations.\n"
            "\nArguments:\n"
            "1. \"bluecoinaddress\"  (string, required) The bluecoin address for transactions.\n"
            "2. minconf             (numeric, optional, default=1) Only include transactions confirmed at least this many times.\n"
            "\nResult:\n"
            "amount   (numeric) The total amount in btc received at this address.\n"
            "\nExamples:\n"
            "\nThe amount from transactions with at least 1 confirmation\n" +
            HelpExampleCli("getreceivedbyaddress", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n" + HelpExampleCli("getreceivedbyaddress", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n" + HelpExampleCli("getreceivedbyaddress", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" 6") +
            "\nAs a json rpc call\n" + HelpExampleRpc("getreceivedbyaddress", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\", 6"));
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"tobluecoinaddress\" amount ( minconf \"comment\" \"comment-to\" )\n"
            "\nSent an amount from an account to a bluecoin address.\n"
            "The amount is a real and is rounded to the nearest 0.00000001." +
            HelpRequiringPassphrase() + "\n"
                                        "\nArguments:\n"
                                        "1. \"fromaccount\"       (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
                                        "2. \"tobluecoinaddress\"  (string, required) The bluecoin address to send funds to.\n"
            ...
            HelpExampleCli("sendfrom", "\"\" \"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n" + HelpExampleCli("sendfrom", "\"tabby\" \"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n" + HelpExampleRpc("sendfrom", "\"tabby\", \"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\", 0.01, 6, \"donation\", \"seans outpost\""));
    ...
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            HelpRequiringPassphrase() + "\n"
                                        ...
                                        "    {\n"
                                        "      \"address\":amount   (numeric) The bluecoin address is the key, the numeric amount in btc is the value\n"
                                        "      ,...\n"
                                        "    }\n"
            ...
            HelpExampleCli("sendmany", "\"tabby\" \"{\\\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n" + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\":0.02}\" 6 \"testing\"") +
            "\nAs a json rpc call\n" + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcg\\\":0.02}\", 6, \"testing\""));
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3) {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
                     ...
                     "2. \"keysobject\"   (string, required) A json array of bluecoin addresses or hex-encoded public keys\n"
                     "     [\n"
                     ...
                     "\nResult:\n"
                     "\"bluecoinaddress\"  (string) A bluecoin address associated with the keys.\n"
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"bluecoinaddress\",    (string) The bluecoin address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"bluecoinaddress\",    (string) The bluecoin address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"bluecoinaddress\",   (string) The bluecoin address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() < 2 || params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending BLUEs\n"
            "\nArguments:\n"
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            "\nPerform a send (requires passphrase set)\n" + HelpExampleCli("sendtoaddress", "\"BJ8Hy9M4zaw1YEQZEj8XKZwZfja1CDdWZs\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending BLUEs\n" + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n" + HelpExampleCli("signmessage", "\"bluecoinaddress\" \"test message\"") +
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending BLUEs.\n"
...
UniValue settxfee(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. amount         (numeric, required) The transaction fee in BLUE/kB rounded to the nearest 0.00000001\n"
            "\nResult\n"
...
UniValue getwalletinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total BLUE balance of the wallet\n"
...
UniValue autocombinerewards(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || (fEnable && params.size() != 2) || params.size() > 2)
        throw runtime_error(
            ...
            "\nWallet will automatically monitor for any coins with value below the threshold amount, and combine them if they reside with the same Bluecoin address\n"
...
UniValue multisend(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            "multisend <Bluecoin Address> <percent>\n"
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid BLUE address");
...
UniValue mintzerocoin(const UniValue& params, bool fHelp)
{
    ...
    if(GetAdjustedTime() > GetSporkValue(SPORK_16_ZEROCOIN_MAINTENANCE_MODE))
        throw JSONRPCError(RPC_WALLET_ERROR, "zBLUE is currently disabled due to maintenance.");
...
UniValue spendzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 5 || params.size() < 4)
        throw runtime_error(
            ...
            "Overview: Convert zBLUE (zerocoins) into BLUE. \n"
            "amount: amount to spend\n"
            "mintchange: if there is left over BLUE (change), the wallet can convert it automatically back to zerocoins [true]\n"
    ...
    bool fMintChange = params[1].get_bool();        // Mint change to zBLUE
