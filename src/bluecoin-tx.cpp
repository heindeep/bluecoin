...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bluecoin Core bluecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bluecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bluecoin transaction") + "\n" +
                               "  bluecoin-tx [options] -create [commands]   " + _("Create hex-encoded bluecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bluecoin transaction
